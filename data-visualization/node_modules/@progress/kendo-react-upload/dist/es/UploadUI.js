...
var UploadUI = /** @class */ (function (_super) {
    ...
    UploadUI.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (ref) { return _this._container = ref; }, className: className, onKeyDown: this.onKeyDown },
            ...
            showActionButtons ?
                React.createElement(UploadActionButtons, { disabled: disabled, navigationIndex: navigationIndex, clearButtonIndex: this.clearButtonIndex, uploadButtonIndex: this.uploadButtonIndex, onUpload: this.onUpload, onClear: this.onClear, onClick: this.onClick }) : undefined));
    };
