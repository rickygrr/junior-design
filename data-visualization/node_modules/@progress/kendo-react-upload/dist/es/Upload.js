    ...
    function Upload(props) {
        ...
        _this.uploadFiles = function (filesForUpload) {
            ...
            stateUtils.groupForEach(filesForUpload, function (currentFiles, uid) {
                ...
                axios(__assign({ method: async.saveMethod, url: async.saveUrl, data: formData, cancelToken: cancelTokenSource.token }, requestOptions, { onUploadProgress: function (event) { return _this.onUploadProgress(event, uid); } }))
            ...
            var onStatusChangeEvent = function () {
                if (_this.props.onStatusChange) {
                    var eventData = {
                        ...
                        response: connectionUtils.convertAxiosResponse(event)
                    };
                    _this.props.onStatusChange.call(undefined, eventData);
                }
            };
