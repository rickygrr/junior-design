...
var Upload = /** @class */ (function (_super) {
    ...
    function Upload(props) {
        ...
        _this.uploadFiles = function (filesForUpload) {
            ...
            stateUtils_1.default.groupForEach(filesForUpload, function (currentFiles, uid) {
                ...
                axios_1.default(__assign({ method: async.saveMethod, url: async.saveUrl, data: formData, cancelToken: cancelTokenSource.token }, requestOptions, { onUploadProgress: function (event) { return _this.onUploadProgress(event, uid); } }))
         ...
         * @hidden
         */
        _this.onUploadProgress = function (event, uid) {
            ...
            var onStatusChangeEvent = function () {
                if (_this.props.onStatusChange) {
                    var eventData = {
                        ...
                        response: connectionUtils_1.default.convertAxiosResponse(event)
                    };
                    _this.props.onStatusChange.call(undefined, eventData);
                }
            };
    ...
    Upload.prototype.render = function () {
        var _a = this.props, showFileList = _a.showFileList, onAdd = _a.onAdd, onRemove = _a.onRemove, autoUpload = _a.autoUpload, showActionButtons = _a.showActionButtons, others = __rest(_a, ["showFileList", "onAdd", "onRemove", "autoUpload", "showActionButtons"]);
