...
var UploadUI = /** @class */ (function (_super) {
     ...
     * @hidden
     */
    UploadUI.prototype.inputRef = function () {
        if (this._uploadAddButton) {
            return this._uploadAddButton.inputRef();
        }
    };
    /**
     * @hidden
    ...
    UploadUI.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (ref) { return _this._container = ref; }, className: className, onKeyDown: this.onKeyDown },
            ...
            showActionButtons ?
                React.createElement(UploadActionButtons_1.UploadActionButtons, { disabled: disabled, navigationIndex: navigationIndex, clearButtonIndex: this.clearButtonIndex, uploadButtonIndex: this.uploadButtonIndex, onUpload: this.onUpload, onClear: this.onClear, onClick: this.onClick }) : undefined));
    };
