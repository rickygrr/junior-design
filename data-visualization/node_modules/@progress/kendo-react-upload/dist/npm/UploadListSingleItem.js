...
var UploadListSingleItem = /** @class */ (function (_super) {
     ...
     * @hidden
     */
    UploadListSingleItem.prototype.getFileValidationMessage = function (file) {
     ...
     * @hidden
     */
    UploadListSingleItem.prototype.renderValidationError = function (file) {
        var exclamation = '!';
        return ([
            (React.createElement("span", { className: 'k-file-invalid-extension-wrapper', key: '1' },
                React.createElement("span", { className: 'k-file-invalid-icon' }, exclamation),
                React.createElement("span", { className: 'k-file-state' }))),
            (React.createElement("span", { className: 'k-file-name-size-wrapper', key: '2' },
                React.createElement("span", { className: 'k-file-name k-file-name-invalid', title: file.name }, file.name),
                React.createElement("span", { className: 'k-file-validation-message' }, this.getFileValidationMessage(file))))
        ]);
    };
    /**
     * @hidden
    ...
    UploadListSingleItem.prototype.renderFileDetails = function (file) {
        return ([
            (React.createElement("span", { className: 'k-file-extension-wrapper', key: '1' },
                React.createElement("span", { className: 'k-file-extension' }, this.getFileExtension(file)),
                React.createElement("span", { className: 'k-file-state' }))),
            (React.createElement("span", { className: 'k-file-name-size-wrapper', key: '2' },
    ...
    UploadListSingleItem.prototype.render = function () {
        ...
        return (React.createElement("div", { className: itemClassName },
            React.createElement("span", { className: 'k-progress', style: {
                    width: (file.progress || 0) + '%',
                    opacity: this.isProgressActive() ? 1 : 0,
                    transition: 'opacity .5s ease-in-out'
                } }),
            file.validationErrors && file.validationErrors.length > 0 ?
                this.renderValidationError(file) :
                undefined,
            !file.validationErrors || file.validationErrors.length === 0 ?
